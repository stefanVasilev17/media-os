...
import { Activity, Bot, Box, CheckCircle2, Circle, Clock3, Network, ShieldCheck } from 'lucide-react';
import { loadLiveMap, type LiveMapJob, type LiveMapTask, type LiveMapView } from '../api/mediaOsApi';
...
export function LiveMapPage() {
  ...
  useEffect(() => {
    loadLiveMap()
      ...
      .catch(err => setError(err instanceof Error ? err.message : 'Live Map could not be loaded'));
  }, []);
