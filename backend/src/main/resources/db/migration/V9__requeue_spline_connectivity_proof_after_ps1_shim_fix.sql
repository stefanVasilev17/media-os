...
values (
  ...
  'SPLINE_JOB_REQUEUED',
  'Spline MCP connectivity proof was requeued after adding PowerShell shim support to the Codex launcher.',
  '{"productionJobId":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1","reason":"powershell-shim-support"}'::jsonb
);
