...
values (
  ...
  'SPLINE_JOB_REQUEUED',
  'Spline MCP connectivity proof was requeued after fixing Windows PowerShell native stderr handling.',
  '{"productionJobId":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1","reason":"native-stderr-handling"}'::jsonb
);
