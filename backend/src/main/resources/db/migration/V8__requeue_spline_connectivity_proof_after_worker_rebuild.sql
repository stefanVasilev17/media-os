...
values (
  ...
  'SPLINE_JOB_REQUEUED',
  'Spline MCP connectivity proof was requeued after rebuilding the Windows PowerShell worker and adding parser validation.',
  '{"productionJobId":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1","reason":"worker-rebuild-parser-validation"}'::jsonb
);
