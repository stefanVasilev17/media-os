...
values (
  ...
  'SPLINE_JOB_REQUEUED',
  'Spline MCP connectivity proof was requeued after switching Codex execution to redirected native process streams.',
  '{"productionJobId":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1","reason":"native-process-redirection"}'::jsonb
);
