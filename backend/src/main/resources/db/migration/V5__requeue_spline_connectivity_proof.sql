...
values (
  ...
  'SPLINE_JOB_REQUEUED',
  'Spline MCP connectivity proof was requeued after adding Codex temp-directory execution support.',
  '{"productionJobId":"aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1","reason":"skip-git-repo-check"}'::jsonb
);
